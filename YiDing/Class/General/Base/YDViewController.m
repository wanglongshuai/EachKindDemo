...
- (void)viewDidLoad {
    ...
    [self layoutNavigationBar:ImageNamed(@"navigationBarBG") titleColor:white_color titleFont:[UIFont boldSystemFontOfSize:18] leftBarButtonItem:nil rightBarButtonItem:nil];
